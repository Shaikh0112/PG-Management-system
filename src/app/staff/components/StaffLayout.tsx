    ...
    <div className="min-h-screen bg-[var(--bg-page)] flex flex-col md:flex-row">
      ...
      `}>
        <div className="flex items-center justify-between p-6 border-b border-[var(--border)] shrink-0">
          <div className="flex flex-col">
            ...
            <p className="text-xs text-[var(--text-secondary)] mt-1 uppercase tracking-wider pl-9">{staffRole || 'Staff'}</p>
          </div>
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="hidden md:flex h-16 bg-[var(--bg-header)] border-b border-[var(--border)] items-center px-6 justify-between shrink-0 sticky top-0 z-20 backdrop-blur-md bg-opacity-80">
          <div className="flex flex-col">
            <h2 className="text-lg font-semibold text-[var(--text-primary)] capitalize leading-tight">
              {pathname.split('/')[2]?.replace('-', ' ') || 'Dashboard'}
            </h2>
            <p className="text-xs text-[var(--text-secondary)] capitalize leading-tight">Role: {staffRole || 'Loading...'}</p>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div className="text-sm text-[var(--text-secondary)]">
              Staff: <strong className="text-[var(--text-primary)]">{user?.name}</strong>
            </div>
