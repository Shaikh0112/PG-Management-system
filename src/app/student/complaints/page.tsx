  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Link href="/student/complaints/new" className="px-4 py-2 bg-[var(--primary)] text-white rounded font-bold shadow-sm flex items-center gap-2 hover:bg-[var(--primary-hover)] transition-colors">
