...
import { AddStudentModal } from '@/app/manager/components/AddStudentModal';
            ...
            {students.map(t => (
              <tr key={t.profile.id} className="hover:bg-[var(--bg-input)] transition-colors">
                ...
                <td className="p-4 text-right">
                  <Link href={`/manager/students/${t.profile.id}`} className="inline-flex items-center gap-1 text-[var(--primary)] hover:underline text-xs font-medium">
