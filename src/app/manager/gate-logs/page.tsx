        ...
        <div className="bg-[var(--bg-card)] border border-[var(--border)] p-5 rounded-[var(--radius-lg,12px)] sticky top-6">
          ...
          <form onSubmit={handleAdd} className="space-y-4">
             <div>
               ...
               <input required type="text" value={studentId} onChange={e=>setStudentId(e.target.value)} placeholder="e.g. ten_123" className="w-full bg-[var(--bg-input)] border border-[var(--border)] px-3 py-2 rounded text-[var(--text-primary)] focus:outline-none focus:border-[var(--primary)]" />
             </div>
             <div>
